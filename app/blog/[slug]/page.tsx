...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (!post) return {};
  return {
    title: `${post.title} | ぷらっとハウス小菅`,
    description: post.excerpt,
    alternates: {
      canonical: `https://kosuge.plat-house.jp/blog/${slug}`,
    },
  };
}
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-16">
      ...
      <div className="mt-16 bg-gray-900 text-white rounded-2xl p-8 text-center">
        <p className="font-bold text-lg mb-2">ぷらっとハウス小菅</p>
        <p className="text-gray-400 text-sm mb-6">小菅駅徒歩7分・民泊・最大4名</p>
        <a
          href="https://beds24.com/booking.php?propid=240672&referer=BookingLink"
